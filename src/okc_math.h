...
#ifndef CPP_NE_2_OKC_MATH_H
#define CPP_NE_2_OKC_MATH_H
...
inline Tensor<T, DEPTH, N_ROWS, M_COLS> operator*(Tensor<T, DEPTH, N_ROWS, N_COLS> n, Tensor<T, DEPTH, N_COLS, M_COLS> m) {
...
template<class T, int DEPTH, int N_ROWS, int N_COLS, int M_COLS>
inline Tensor<T, DEPTH, N_ROWS, M_COLS> operator*(Eigen::Matrix<T, N_ROWS, N_COLS> n, Tensor<T, DEPTH, N_COLS, M_COLS> m) {
    Tensor<T, DEPTH, N_ROWS, M_COLS> result;
    for (size_t i = 0; i < DEPTH; ++i)
        result[i] = n * m[i];
    return result;
...
// Tensor * Matrix
template<class T, int DEPTH, int N_ROWS, int N_COLS, int M_COLS>
inline Tensor<T, DEPTH, N_ROWS, M_COLS> operator*(Tensor<T, DEPTH, N_ROWS, N_COLS> n, Eigen::Matrix<T, N_COLS, M_COLS> m) {
    Tensor<T, DEPTH, N_ROWS, M_COLS> result;
    for (size_t i = 0; i < DEPTH; ++i)
        result[i] = n[i] * m;
    return result;
...
inline Eigen::Matrix<T, N_ROWS, DEPTH> tvp(Tensor<T, DEPTH, N_ROWS, N_COLS> n, Eigen::Vector<T, N_COLS> m) {
